...
export const agregarFavorito: ActionCreator<AgregarFavorito> = (personajes: Personajes) => {
    return {
        type: "AGREGAR_FAVORITO",
        personajes: personajes
    }
...
export const eliminarFavorito: ActionCreator<EliminarFavorito> = (personajes: Personajes) => {
    return {
        type: "ELIMINAR_FAVORITO",
        personajes: personajes
    }
...
export const eliminarTodosFavoritos: ActionCreator<EliminarTodosFavoritos> = () => {
    return {
        type: "ELIMINAR_TODOS_FAVORITOS"
    }
};